...
def config(args):
    ...
    # args.data_dir = '/mnt/ve_perception/likaiying/opendataset/sandbox/PersFormer_3DLane_main/dataset/apollo/data_splits/standard' 

    args.dataset_name = 'haomodata'
    args.dataset_dir = '/mnt/ve_perception/likaiying/opendataset/sandbox/PersFormer_3DLane_main/haomodata'  
    args.data_dir = '/mnt/ve_perception/likaiying/opendataset/sandbox/PersFormer_3DLane_main/haomodata'
...
def sim3d_config(args):
    ...
    #                    [0., 2015., 540.],
    #                    [0., 0., 1.]])
    args.K = np.array([[1963.4412841796875, 0., 973.6448974609375],
                       [0., 1973.016845703125, 588.2520751953125],
                       [0., 0., 1.]])
