...
class EncoderLayer(nn.Module):
    ...
    def forward(self,
        ...
        query = self.self_attn( query + bev_pos,       #        bev query的self-attention，以bev grid作为attention中心点
        ...
        # cross attention
        query = self.cross_attn(query,                        # 以内外参数确定target和reference实现cross attention
